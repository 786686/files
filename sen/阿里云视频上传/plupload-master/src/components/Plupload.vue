...
export default {
  ...
  methods: {
    ...
    set_upload_param(up, filename, ret) {
      ...
      // axios.get("http://vue.wxeepp.com/SchoolAdmin/v2/Vupload/getUploadAuth").then((data) => {
      //   console.log(data)
      ...
      // })
      // return;
      const accessid = "STS.NV4vuwruM6pLaCE1fhV6Do3sK";
      const accesskey = "NTcoJ5EjTJQMjr8SKhtmF8K7W";
      const host = "https://wxchuangke.oss-cn-shenzhen.aliyuncs.com"; // 注意这里的http 或 https
      // const host = "http://oss.wxeepp.com"; // 注意这里的http 或 https
